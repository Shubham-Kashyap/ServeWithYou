      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ URL::to('/admin/providers/add-associated-providers/'.$company_id) }}" method="post" class="add_agent" enctype="multipart/form-data" class="add_agent">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="company" id="company" class="form-control select-2">
                    ...
                    <option value="{{ Helper::getCompanyData($company_id)->company_id }}">{{ Helper::getCompanyData($company_id)->company_name }}</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="address" id="branch" placeholder="Enter Address" value="{{ old('address') }}" onkeyup="searchBranch();">
                    <div id="address"></div>
