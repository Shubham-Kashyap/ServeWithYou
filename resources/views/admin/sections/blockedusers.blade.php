        ...
        <!-- ./session alerts -->
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <!-- <a href="{{ URL::to('admin/users/all-users') }}" class="btn btn bg-olive"> Check un-blocked users</a> -->
              </div>
                ...
                <table id="users" class="table display table-bordered table-striped" style="width:100%;">
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          @endif
                      <td>
                          <!-- <a href="{{ URL('/admin/user-management/user/edit').'/'.$row->id }}" class="btn btn-xs btn-success" >Edit</a> -->
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a href="{{ URL('/admin/user-management/user/delete').'/'.$row->id }}" class="btn btn-danger"> Delete user</a>
                                      </div>
                                    </div>
                                  </div>
                                </div> -->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                      <a href="{{ URL('/admin/users/user-management/unblock-user/').'/'.$row->id }}" class="btn btn bg-navy"> Unblock user </a>
                                    </div>
                                  </div>
                                </div>
                              </div>                             
