...
<div class="row">
      <div class="col-md-5">
            ...
            <div class="widget-user-header bg-navy" style="background: url('/aaadmin_files/dist/img/photo1.png') center center;">
            ...
            <div class="box-footer">
              ...
              <a href="{{ URL('/admin/providers/view-provider/').'/'.$provider_data->user_id }}" target="_blank" class="btn bg-navy btn-block"><b>view more info</b></a>
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="box-footer">
              ...
              <a href="{{ URL::to('admin/jobs/all-jobs') }}" class="btn bg-navy btn-block"><b>Go Back</b></a>
            </div>
              <!-- /.row -->
            </div>
          </div>
