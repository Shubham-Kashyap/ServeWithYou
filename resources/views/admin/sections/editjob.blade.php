      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ URL::to('/admin/jobs/edit-job/'.$data->id) }}" method="post" class="add_agent" enctype="multipart/form-data" class="add_agent">
              <div class="box-body">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <a href="{{ URL::to('admin/jobs/edit-job/delete-image').'/'.$data->id.'/'.$img }}" class="btn btn-danger">Delete image</a>
