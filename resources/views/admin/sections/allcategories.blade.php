        ...
        <!-- ./session alerts -->
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <a href="{{ URL::to('admin/categories/add-categories') }}" class="btn btn bg-navy"> <i class="fa fa-plus ">  </i> Add Categories</a>
              </div>
              ...
              <div class="table-responsive">
                ...
                <table id="categories" class="table display table-bordered table-striped" style="width:100%;">
                  ...
                  <tr>
                    ...
                    <td>
                      <!-- <a href="{{ URL::to('admin/categories/edit-category/'.$row->id) }}" class="btn btn-xs bg-navy" >Edit</a> -->
                      <!-- <a href="{{ URL::to('admin/categories/delete-category/'.$row->id) }}" class="btn btn-xs bg-navy" >Delete</a> -->

                        <div class="btn-group" style="width:80px;">
                          <a href="{{ URL::to('admin/categories/edit-category/'.$row->id) }}" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-xs bg-navy"><i class="fa fa-pencil "></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <a href="{{ URL('/admin/categories/categories-management/delete-category').'/'.$row->id }}" class="btn btn-danger"> Delete category</a>
