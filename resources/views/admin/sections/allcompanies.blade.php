        ...
        <!-- ./session alerts -->
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <a href="{{ URL::to('admin/companies/add-company') }}" class="btn btn bg-navy"> <i class="fa fa-plus ">  </i> Add Company</a>
                      ...
                      <td>
                        ...
                        <td>
                          <div class="btn-group" style="width:80px;">
                            <a href="{{ URL('/admin/companies/edit-company/').'/'.$row->id }}" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-xs bg-navy"><i class="fa fa-pencil "></i></a>
                            <a href="{{ URL('/admin/companies/view-company/').'/'.$row->id }}" data-toggle="tooltip" data-placement="top" title="View" class="btn btn-success btn-xs"><i class="fa  fa-eye"></i></a>
                            <a href="{{ URL('/admin/companies/view-company-employes/').'/'.$row->id }}" data-toggle="tooltip" data-placement="top" title="Associated employees" class="btn btn-success btn-xs"><i class="ion ion-ios-people"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <a href="{{ URL('/admin/companies/company-management/delete-company').'/'.$row->id }}" class="btn bg-navy"> Delete company</a>
