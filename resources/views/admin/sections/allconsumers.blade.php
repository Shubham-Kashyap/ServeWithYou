        ...
        <!-- ./session alerts -->
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <a href="{{ URL::to('admin/consumers/add-consumer') }}" class="btn btn bg-navy"> <i class="fa fa-plus ">  </i> Add Consumers</a>
                ...
                <table id="users" class="table display table-bordered table-striped" style="width:100%;">
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <!-- <a href="{{ URL('/admin/consumers/edit-consumer/').'/'.$row->user_id }}" class="btn btn-xs bg-navy">Edit</a> -->
                          <!-- <a href="{{ URL('/admin/consumers/view-consumer/').'/'.$row->user_id }}" class="btn btn-xs btn-success">View</a> -->

                          <div class="btn-group" style="width:80px;">
                            <a href="{{ URL('/admin/consumers/edit-consumer/').'/'.$row->user_id }}" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-xs bg-navy"><i class="fa fa-pencil "></i></a>
                            <a href="{{ URL('/admin/consumers/view-consumer/').'/'.$row->user_id }}" data-toggle="tooltip" data-placement="top" title="View" class="btn btn-success btn-xs"><i class="fa  fa-eye"></i></a>
