      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ URL::to('/admin/providers/edit-provider/'.$data->user_id) }}" method="post" class="add_agent" enctype="multipart/form-data" class="add_agent">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="account_number" id="accpunt" placeholder="Enter account number" value="{{ $data->account_number }}">
                </div>
                <div class="form-group">
