                    ...
                    <tr>
                        ...
                        <td>
                            @if($row->job_done_status == 'done')
                                <span class="label label-xs bg-navy">Done</span>
                                @else
                        ...
                        <!-- <a href="{{ URL::to('subadmin/categories/edit-category/'.$row->id) }}" class="btn btn-xs btn-success" >Edit</a>
                        <a href="{{ URL::to('subadmin/categories/edit-category/'.$row->id) }}" class="btn btn-xs btn-success" >Edit</a>
                        <a href="{{ URL::to('subadmin/categories/edit-category/'.$row->id) }}" class="btn btn-xs btn-success" >Edit</a> -->
                        </td>
                    </tr>
