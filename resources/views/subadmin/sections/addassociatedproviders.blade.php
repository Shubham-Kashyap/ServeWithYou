      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ URL::to('/subadmin/providers/add-associated-providers/'.$company_id) }}" method="post" class="add_agent" enctype="multipart/form-data" class="add_agent">
              <div class="box-body">
