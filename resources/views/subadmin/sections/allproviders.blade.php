        ...
        <!-- ./session alerts -->
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
              @if(Auth::guard('subadmin')->user()->add_provider_permission == 'on')
                <a href="{{ URL::to('subadmin/providers/add-providers') }}" class="btn btn bg-navy"> <i class="fa fa-plus ">  </i>Add Provider</a>
              @endif
              </div>
              ...
              <div class="table table-hover table-responsive">
                ...
                <table id="providers" class="table display table-bordered table-striped" style="width:100%;">
                  ...
                  <tr>
                      ...
                      <td>
                          <!-- <a href="{{ URL('subadmin/providers/edit-provider/'.$row->user_id) }}" class="btn btn-xs bg-navy" >Edit</a>
                          <a href="{{ URL('/subadmin/providers/view-provider/').'/'.$row->user_id }}" class="btn btn-xs btn-success">View</a> -->

                          <div class="btn-group" style="width:80px;">
                          @if(Auth::guard('subadmin')->user()->edit_provider_permission == 'on')
                            <a href="{{ URL('subadmin/providers/edit-provider/'.$row->user_id) }}" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-xs bg-navy"><i class="fa fa-pencil "></i></a>
                          @endif
                            <a href="{{ URL('/subadmin/providers/view-provider/').'/'.$row->user_id }}" data-toggle="tooltip" data-placement="top" title="View" class="btn btn-success btn-xs"><i class="fa  fa-eye"></i></a>
