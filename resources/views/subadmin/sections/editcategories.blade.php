...
<section class="content-header">
      <h1>
        Edit Categories
        <small>Edit a exsisting category to the list</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Category -- {{ $data->id }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ URL::to('/subadmin/categories/edit-category/'.$data->id) }}" method="post"  enctype="multipart/form-data">
              <div class="box-body">
                <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                <input name="edit_category_permission" type="hidden" value="on"/>
                <div class="form-group">
                  <label for="category_name">Service Category Name</label>
                  <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Enter category name" value="{{ $data->service_category }}">
                </div> 
