...
<head>
  ...
  <!-- select 2  -->
  <link rel="stylesheet" href="{{ url('admin_files/plugins/select2/select2.min.css')}}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ URL::to('subadmin/dashboard') }}" class="logo">
    ...
    <!-- navabr -->
    @include('subadminLayouts.navbar')
    <!-- ./navbar -->
  </header>
  <!-- sidebar column. contains the logo and sidebar -->
    @include('subadminLayouts.sidebar')
  <!-- /.sidebar column. contains the logo and sidebar -->
...
<!-- select 2 plugin  -->
<script src="{{ url('admin_files/plugins/select2/select2.full.min.js') }}"></script>
<!-- AdminLTE App -->
...
$(function () {
  ...
  $('.subadminlogout_btn').click(function(){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href="/public/subadmin/logout";
      }
    })
  });
